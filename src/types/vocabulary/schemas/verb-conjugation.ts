...
export const VerbPersonFormsSchema = z.object({
  first: z.array(z.string()).nullable(),
  second: z.array(z.string()).nullable(),
  third: z.array(z.string()).nullable(),
});
...
export const GerundTableSchema = z.object({
  genitive: z.array(z.string()).nullable(),
  dative: z.array(z.string()).nullable(),
  accusative: z.array(z.string()).nullable(),
  ablative: z.array(z.string()).nullable(),
});
