...
// ==================== Main Mapper ====================
// V4 Changes:
// - Adjectives: Added dictionary_forms field (array of WordForm for dictionary entry like "bonus, -a, -um")
// - Adjectives: degrees_table structure already implemented in v3
// - Output collection: vocabularyWords-v4

export function mapLegacyWordV4(
  data: URec
