...
export default function PracticeSidebar({
  ...
  return (
    <CollapsibleSidebarShell
      ...
      closeLabel="Close practice sidebar"
      expandLabel="Expand practice sidebar"
      collapseLabel="Collapse practice sidebar"
      railLabel="Practice"
      railIcon={<Pencil className="h-5 w-5 text-roman-red" />}>
