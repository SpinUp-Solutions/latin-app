...
export default function LessonSidebar({ currentLessonId, isCollapsed = false, onToggleCollapse }: LessonSidebarProps) {
  ...
  return (
    <CollapsibleSidebarShell
      ...
      closeLabel="Close lessons sidebar"
      expandLabel="Expand lessons sidebar"
      collapseLabel="Collapse lessons sidebar"
      railLabel="Path"
      railIcon={<BookOpen className="h-5 w-5 text-roman-red" />}>
