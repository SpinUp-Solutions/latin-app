  ...
  return (
    <div className="mb-7 flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
      <div className="min-w-0">
        <h1 className={cn('font-serif text-2xl leading-tight sm:text-3xl', headingClassName)} {...restHeadingProps}>
          {title}
        </h1>
        {description && (
          <div className="mt-1.5 max-w-2xl text-sm leading-relaxed text-roman-stone sm:text-base">{description}</div>
        )}
      </div>
