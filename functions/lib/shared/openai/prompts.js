...
exports.INDECLINABLE_PROMPT = exports.PRONOUN_PROMPT = exports.ADJECTIVE_PROMPT = exports.VERB_PROMPT = exports.NOUN_PROMPT = exports.SYSTEM_PROMPT = void 0;
exports.getPromptForPartOfSpeech = getPromptForPartOfSpeech;
exports.SYSTEM_PROMPT = `You are a Latin language expert. Provide comprehensive grammatical information: translations, definitions, etymology, pronunciation, and complete inflection tables.
...
exports.NOUN_PROMPT = `Analyze the Latin noun "{word}". Provide complete information including nominative_singular and genitive_singular with both full and shortened forms.`;
exports.VERB_PROMPT = `Analyze the Latin verb "{word}". Provide COMPLETE conjugation information:
...
exports.ADJECTIVE_PROMPT = `Analyze the Latin adjective "{word}". Provide complete information.`;
exports.PRONOUN_PROMPT = `Analyze the Latin pronoun "{word}". Provide complete information.`;
exports.INDECLINABLE_PROMPT = `Analyze the Latin {partOfSpeech} "{word}". Provide complete information.`;
function getPromptForPartOfSpeech(partOfSpeech, word) {
    switch (partOfSpeech) {
        case 'noun':
            return exports.NOUN_PROMPT.replace('{word}', word);
        case 'verb':
            return exports.VERB_PROMPT.replace('{word}', word);
        case 'adjective':
            return exports.ADJECTIVE_PROMPT.replace('{word}', word);
        case 'pronoun':
            return exports.PRONOUN_PROMPT.replace('{word}', word);
        case 'adverb':
        case 'preposition':
        case 'conjunction':
        case 'interjection':
            return exports.INDECLINABLE_PROMPT.replace('{word}', word).replace('{partOfSpeech}', partOfSpeech);
        default:
